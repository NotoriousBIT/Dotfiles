...
awful.util.tagnames = { " TERM ", " DEV ", " WWW ", " SOCIAL ", " GIT ", " VBOX ", " FLOAT " }
...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -i  -nb '#292d3e' -nf '#12B0FF' -sb '#ffa300' -sf '#292d3e' -fn 'Mononoki Nerd Font:bold:pixelsize=14'",
    ...
    awful.key({ modkey, "Shift" }, "a", function () awful.util.spawn( "pavucontrol" ) end,
        {description = "Simple GTK volume control tool (\"mixer\") for PulseAudio" , group = "apps" }),
    ...
    awful.key({ modkey, "Shift"  }, "c", function () awful.util.spawn( "code" ) end,
        {description = "VS Code" , group = "apps" }),

    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("spectacle") end,
        {description = "Spactacle Tool", group = "screenshots"}),
